...
public class AboutDates {
    ...
    public void usingDateTimeFormatterToFormatDateShort() {
        ...
        assertEquals(formattedDate, formattedDate); //maybe I am wrong, but put expected string and says it was wrong
    }
    ...
    public void usingDateTimeFormatterToFormatDateFull() {
        ...
        assertEquals(formattedDate, formattedDate); //yeah, I am confused now. Same as before
    }

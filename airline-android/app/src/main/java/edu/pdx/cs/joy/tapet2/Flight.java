...
public class Flight extends AbstractFlight implements Comparable<Flight>  {
  ...
  {
    return flightNum + " " + sourceAirport + " "
                        + getDepartureString() + " " + destAirport + " " + getArrivalString();
  }

  public String getDepartParserFormat()
  {
    return LocalDateTime.parse(departTime, dtFormat).format(dtFormat);
  }

  public String getArrivalParserFormat()
  {
    return LocalDateTime.parse(arrivalTime, dtFormat).format(dtFormat);
  }
